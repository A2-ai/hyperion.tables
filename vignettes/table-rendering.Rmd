...
`render_to_word()` saves a rendered `gt` or `flextable` object to a `.docx`
file. Inline LaTeX (`$...$`) in the rendered table is preserved as native
Word equations rather than literal text. Pass `landscape = TRUE` for
