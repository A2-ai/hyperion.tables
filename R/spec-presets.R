...
#' parameter table layout: omega estimates displayed as CV, display names
#' from the parameter lookup, and parameters grouped into sections by kind
...
#' @param title Table title. If NULL (the default), the standard [TableSpec]
...
parameter_table_spec <- function(
  ...
  # else: keep the TableSpec() constructor default title ("Model Parameters")
  spec
}
